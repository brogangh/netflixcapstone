...
#month except quarterly which is day
...
plt.savefig('distribution_2017.png')
plt.show()
...
plt.title('revenue by quarter in billions ($)')
plt.savefig('revenue_by_quarter.png')
plt.show()

plt.clf()

plt.bar(quarter_labels, earnings_by_quarter)
plt.title('earnings by quarter in billions ($)')
plt.savefig('earnings_by_quarter.png')
plt.show()
